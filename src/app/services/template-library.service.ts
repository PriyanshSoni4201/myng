...
export class TemplateLibraryService {
  ...
  private buildStandardTable(item: any): string {
    ...
    const hasLine = item.isTableViewWithLine === true;
    const borderStyle = hasLine ? 'border-bottom: 1px solid #c0c0c0;' : '';
    ...
    // The border-bottom has been removed from the <tr> style here
    ...
    return `
      <div style="margin-top: 15px; font-family: sans-serif; font-size: 11px;">
        <div style="font-weight: bold; font-size: 13px; padding-bottom: 2px; margin-bottom: 5px; ${borderStyle}">
          ${headerTitle}
        </div>
  ...
  /*
  SAMPLE INPUT for buildStandardTable:
  {
    "header": "ODP/HPI",
    "isTableViewWithLine": true,
    "column": 0,
    "tableData": [ { "No.": 1, "Date": "...", "Remarks": "..." } ]
  }
  */
