...
export class HomeComponent {
  ...
  pdfOptions = {
    ...
    format: 'a4',
    orientation: 'p',
    filename: 'Medical-Report-Final.pdf',
  };
  ...
  // NOTE: This background image should ONLY contain the topmost letterhead, not the repeating blue footer.
  backgroundImageSrc = 'public/bg.png'; // Make sure this path is correct for your letterhead image.
        ...
        <tr>
          <td style="width: 50%; vertical-align: top; padding: 5px;">
            <table style="width: 100%; border-collapse: collapse; font-size: 11px;">
              <tr>
                <td style="font-weight: bold; padding: 1px 2px; width: 100px;">UHID</td>
                <td style="padding: 1px 2px;">13121200000030</td>
              </tr>
              <tr>
                <td style="font-weight: bold; padding: 1px 2px;">Encounter No.</td>
                <td style="padding: 1px 2px;">RFT-20250618-0423</td>
              </tr>
              <tr>
                <td style="font-weight: bold; padding: 1px 2px;">Address</td>
                <td style="padding: 1px 2px;">Malad East, Mumbai</td>
              </tr>
              <tr>
                <td style="font-weight: bold; padding: 1px 2px;">Diagnosis</td>
                <td style="padding: 1px 2px;">Hypertension & Diabetes</td>
              </tr>
            </table>
          </td>
          ...
          <td style="width: 50%; vertical-align: top; padding: 5px;">
             <table style="width: 100%; border-collapse: collapse; font-size: 11px;">
              <tr>
                <td style="font-weight: bold; padding: 1px 2px; width: 80px;">Consultant</td>
                <td style="padding: 1px 2px;">Dr. Abhinav Vapte MD DM</td>
              </tr>
              <tr>
                <td style="font-weight: bold; padding: 1px 2px;">Ref. By</td>
                <td style="padding: 1px 2px;">Dr. Anita Sharma</td>
              </tr>
              <tr>
                <td style="font-weight: bold; padding: 1px 2px;">Payer Class</td>
                <td style="padding: 1px 2px;">Self</td>
              </tr>
            </table>
          </td>
        </tr>
  ...
  mainContentHtml: string = `
    ...
    <table style="width: 100%; border-collapse: collapse; font-family: sans-serif; font-size: 11px; margin-top: 3px;">
      <thead>
        <tr>
          <th style="text-align: left; padding: 2px; font-weight: bold; width: 6%;">No.</th>
          <th style="text-align: left; padding: 2px; font-weight: bold; width: 24%;">Chief Complaint</th>
          <th style="text-align: left; padding: 2px; font-weight: bold; width: 12%;">Duration</th>
          <th style="text-align: left; padding: 2px; font-weight: bold;">Remarks</th>
        </tr>
      </thead>
      <tbody>
        <tr>
          <td style="padding: 2px; vertical-align: top;">1</td>
          <td style="padding: 2px; vertical-align: top;">Gastrointestinal<br>Neuroendocrine Tumors</td>
          <td style="padding: 2px; vertical-align: top;">5 Days</td>
          <td style="padding: 2px; vertical-align: top;">The patient reports experiencing a high fever of 101.5°F, accompanied by significant chills, overwhelming fatigue, and a persistent cough.</td>
        </tr>
        <tr>
          <td style="padding: 2px; vertical-align: top;">2</td>
          <td style="padding: 2px; vertical-align: top;">Cough</td>
          <td style="padding: 2px; vertical-align: top;">3 Days</td>
          <td style="padding: 2px; vertical-align: top;">The patient reports experiencing chills and profound fatigue. Additionally, they describe occasional chest pain that feels sharp and intensifies with deep breaths.</td>
        </tr>
        <tr>
          <td style="padding: 2px; vertical-align: top;">3</td>
          <td style="padding: 2px; vertical-align: top;">Chest Pain</td>
          <td style="padding: 2px; vertical-align: top;">12 Days</td>
          <td style="padding: 2px; vertical-align: top;">The patient is showing signs of chills and notable fatigue. They also mention a dry cough that is persistent and irritating, causing discomfort in the throat and occasionally leading to shortness of breath.</td>
        </tr>
      </tbody>
    </table>
    ...
    <table style="width: 100%; border-collapse: collapse; font-family: sans-serif; font-size: 11px; margin-top: 3px;">
      <thead>
        <tr>
          <th style="text-align: left; padding: 2px; font-weight: bold; width: 6%;">No.</th>
          <th style="text-align: left; padding: 2px; font-weight: bold; width: 15%;">Date</th>
          <th style="text-align: left; padding: 2px; font-weight: bold;">Remarks</th>
        </tr>
      </thead>
      <tbody>
        <tr>
          <td style="padding: 2px; vertical-align: top;">1</td>
          <td style="padding: 2px; vertical-align: top;">24-Dec-2003</td>
          <td style="padding: 2px; vertical-align: top;">Chest pain began approximately 1 hour ago while at rest, squeezing or pressure in the chest which radiates down the left arm. History of hypertension & high cholesterol. No known allergies. Sedentary lifestyle, moderate alcohol consumption.</td>
        </tr>
        <tr>
          <td style="padding: 2px; vertical-align: top;">2</td>
          <td style="padding: 2px; vertical-align: top;">24-Dec-2003</td>
        ...
        <tr>
          <td style="padding: 2px; vertical-align: top;">3</td>
          <td style="padding: 2px; vertical-align: top;">04-Jan-2006</td>
          <td style="padding: 2px; vertical-align: top;">Chest pain began approximately 1 hour ago while at rest, squeezing or pressure in the chest which radiates down the left arm. History of hypertension & high cholesterol. No known allergies. Sedentary lifestyle, moderate alcohol consumption.</td>
        </tr>
      </tbody>
    </table>
    ...
    <table style="width: 100%; border-collapse: collapse; font-family: sans-serif; font-size: 11px; margin-top: 3px;">
      <thead>
        <tr>
          <th style="text-align: left; padding: 2px; font-weight: bold; width: 6%;">No.</th>
          <th style="text-align: left; padding: 2px; font-weight: bold; width: 24%;">Disease</th>
          <th style="text-align: left; padding: 2px; font-weight: bold; width: 20%;">Onset Date</th>
          <th style="text-align: left; padding: 2px; font-weight: bold;">Remarks</th>
        </tr>
      </thead>
      <tbody>
    ...
    <table style="width: 100%; border-collapse: collapse; font-family: sans-serif; font-size: 11px; margin-top: 3px;">
      <tbody>
        <tr><td style="padding: 2px; font-weight: bold; width: 25%;">No.</td><td style="padding: 2px;" colspan="3">1</td></tr>
    ...
    <table style="width: 100%; border-collapse: collapse; font-family: sans-serif; font-size: 11px; margin-top: 3px;">
      <thead>
        <tr>
          <th style="text-align: left; padding: 2px; font-weight: bold; width: 6%;">No.</th><th style="text-align: left; padding: 2px; font-weight: bold; width: 24%;">Lifestyle</th><th style="text-align: left; padding: 2px; font-weight: bold; width: 35%;">Parameters</th><th style="text-align: left; padding: 2px; font-weight: bold;">Remarks</th>
        </tr>
      </thead>
      <tbody>
    ...
    <table style="width: 100%; border-collapse: collapse; font-family: sans-serif; font-size: 11px; margin-top: 3px;">
      <thead>
        <tr>
          <th style="text-align: left; padding: 2px; font-weight: bold; width: 6%;">No.</th><th style="text-align: left; padding: 2px; font-weight: bold;">Relation</th><th style="text-align: left; padding: 2px; font-weight: bold;">Current Age</th><th style="text-align: left; padding: 2px; font-weight: bold;">Disease</th><th style="text-align: left; padding: 2px; font-weight: bold;">Onset Age</th><th style="text-align: left; padding: 2px; font-weight: bold;">Remarks</th>
        </tr>
      </thead>
      <tbody>
    ...
    <table style="width: 100%; border-collapse: collapse; font-family: sans-serif; font-size: 11px; margin-top: 3px;">
        <thead>
            <tr>
                <th style="text-align: left; padding: 2px; font-weight: bold; width: 6%;">No.</th><th style="text-align: left; padding: 2px; font-weight: bold;">Allergy</th><th style="text-align: left; padding: 2px; font-weight: bold;">Allergen</th><th style="text-align: left; padding: 2px; font-weight: bold;">Type of Reaction</th><th style="text-align: left; padding: 2px; font-weight: bold;">Onset Date</th><th style="text-align: left; padding: 2px; font-weight: bold;">Severity</th><th style="text-align: left; padding: 2px; font-weight: bold;">Remarks</th>
            </tr>
        </thead>
        <tbody>
    ...
    <table style="width: 100%; border-collapse: collapse; text-align: center; font-family: sans-serif; font-size: 11px; margin-top: 3px;">
      <thead>
        <tr>
          <th style="padding: 2px; font-weight: bold;">Pulse</th><th style="padding: 2px; font-weight: bold;">SBP</th><th style="padding: 2px; font-weight: bold;">DBP</th><th style="padding: 2px; font-weight: bold;">Temp</th><th style="padding: 2px; font-weight: bold;">RR</th><th style="padding: 2px; font-weight: bold;">SPO2</th><th style="padding: 2px; font-weight: bold;">Height</th><th style="padding: 2px; font-weight: bold;">Weight</th><th style="padding: 2px; font-weight: bold;">BMI</th><th style="padding: 2px; font-weight: bold;">PEFR</th><th style="padding: 2px; font-weight: bold;">RBS</th>
        </tr>
      </thead>
      <tbody>
        <tr><td style="padding: 2px;">78 bpm</td><td style="padding: 2px;">45 mmHg</td><td style="padding: 2px;">70 mmHg</td><td style="padding: 2px;">36 °C</td><td style="padding: 2px;">18 bpm</td><td style="padding: 2px;">96 %</td><td style="padding: 2px;">174 cm</td><td style="padding: 2px;">54 kg</td><td style="padding: 2px;">18.3</td><td style="padding: 2px;">90</td><td style="padding: 2px;">78 mg</td></tr>
      </tbody>
    </table>
    ...
    <table style="width: 100%; border-collapse: collapse; font-family: sans-serif; font-size: 11px; margin-top: 3px;">
      <tbody>
        <tr>
          <td style="width: 25%; font-weight: bold; padding: 2px; vertical-align: top;">Level of Consciousness</td><td style="width: 25%; padding: 2px; vertical-align: top;">Alert</td><td style="width: 25%; font-weight: bold; padding: 2px; vertical-align: top;">Distress</td><td style="width: 25%; padding: 2px; vertical-align: top;">Chest Pain</td>
        </tr>
        <tr>
          <td style="font-weight: bold; padding: 2px; vertical-align: top;">Hygiene and Grooming</td><td style="padding: 2px; vertical-align: top;">Adequately Groomed</td><td style="font-weight: bold; padding: 2px; vertical-align: top;">Build and Nutrition</td><td style="padding: 2px; vertical-align: top;">Normal Build and Well-Nourished</td>
        </tr>
        <tr>
          <td style="font-weight: bold; padding: 2px; vertical-align: top;">Head & Face</td><td style="padding: 2px; vertical-align: top;">Normal shape, no swelling</td><td style="font-weight: bold; padding: 2px; vertical-align: top;">Facial Expression</td><td style="padding: 2px; vertical-align: top;">Anxiety</td>
        </tr>
        <tr>
          <td style="font-weight: bold; padding: 2px; vertical-align: top;">Eyes</td><td style="padding: 2px; vertical-align: top;">Clear, no redness</td><td style="font-weight: bold; padding: 2px; vertical-align: top;">Skin</td><td style="padding: 2px; vertical-align: top;">No rash or marks</td>
        </tr>
        <tr>
          <td style="font-weight: bold; padding: 2px; vertical-align: top;">Neck</td><td style="padding: 2px; vertical-align: top;">Normal, no swelling</td><td style="font-weight: bold; padding: 2px; vertical-align: top;">Lymph Nodes</td><td style="padding: 2px; vertical-align: top;">Not swollent</td>
        </tr>
        <tr>
          <td style="font-weight: bold; padding: 2px; vertical-align: top;">Mouth & Throat</td><td style="padding: 2px; vertical-align: top;">No sores, throat normal</td><td style="font-weight: bold; padding: 2px; vertical-align: top;">Mental Status and Behavior</td><td style="padding: 2px; vertical-align: top;">Calm and cooperative</td>
        </tr>
        <tr>
          <td style="font-weight: bold; padding: 2px; vertical-align: top;">Spine</td><td style="padding: 2px; vertical-align: top;">Straight, no pain</td><td style="font-weight: bold; padding: 2px; vertical-align: top;">Extremities</td><td style="padding: 2px; vertical-align: top;">No injuries</td>
        </tr>
        <tr>
          <td style="font-weight: bold; padding: 2px; vertical-align: top;">Extremities</td><td style="padding: 2px; vertical-align: top;">No swelling, normal</td><td></td><td></td>
        </tr>
      </tbody>
    </table>
